...
final class Fooorms
{
    ...
    public function __construct()
    {
        ...
        if ($this->has_acf()) {
            ...
            include_once($this->plugin_path() . '/includes/acf/class-admin-smtp.php');

            $this->fields_provider = new ACF\Extension();
            new ACF\Admin_Forms();
     ...
     * @return mixed|null
     */
    public function get_meta($name, $id)
    {
    ...
    public function get_form_field_types()
    {
        ...
        return [
            'input_text'    => [
                'type'  => 'string',
                'label' => __('Text input (text, email, hidden etc) (type: "string")', 'fooorms')
            ],
            'input_integer' => [
                'type'  => 'integer',
                'label' => __('Input type "number" for integers (type: "integer")', 'fooorms')
            ],
            'input_number'  => [
                'type'  => 'number',
                'label' => __('Input type "number" for decimals (type: "number")', 'fooorms')
            ],
            'textarea'      => [
                'type'  => 'string',
                'label' => __('Textarea (type: "string")', 'fooorms')
            ],
            'select'        => [
                'type'  => 'string',
                'label' => __('Select (type: "string")', 'fooorms')
            ],
            'input_radio'   => [
                'type'  => 'string',
                'label' => __('Radio input (type: "string")', 'fooorms')
            ],
            'checkboxes'    => [
                'type'  => 'array',
     ...
     * @return void
     */
    public function set_smtp_log($text)
    {
        $this->smtp_logs[] = $text;
    }
     ...
     * @return array
     */
    public function get_smtp_log()
    {
        return $this->smtp_logs;
    }

    /**
     * @return void
     */
    public function clear_smtp_log()
    {
        $this->smtp_logs = [];
    }
